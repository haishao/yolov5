    ...
    if rank in [-1, 0]:
        ...
        if not opt.resume:
            ...
            if not opt.noautoanchor:
                check_anchors(dataset, model=model, thr=hyp['anchor_t'], imgsz=imgsz, labels_subdir=opt.labels_subdir)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--labels_subdir', type=str, default='labels', help='labels subdir name, parallel to "images"')
